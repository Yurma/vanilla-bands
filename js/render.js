(function(d, namespace){
    var renderItem = function (type, value = "", {attributes, events} = {}) { //Funkcija koju koristim za kreiranje elemenata
    ...
    var renderNew = function (bandList) { // Funckcija koja rendera dio stranice vezan za dodavanje novog benda/glazbenika
        ...
        var submit = renderItem("button", "Submit", {events: {"click": function(){
            if(bandRadio.checked) { //Ako je Band radio oznacen radit ce se Band objekt, a ako je Solo oznacen radi se Solo objekt
                ...
                bandList.addList(new namespace.Band(bandName, genre)).lastId;
                ...
                bandList.addList(new namespace.Solo(soloFirstName, soloLastName, genre)).lastId;
            }
