function Band(name, genre) { //Funkcija koja sluzi za kreiranje objekta preko objektnog konstruktora
    this.bandName = name;
    this.genre = genre;
    this.type = "Band";
}

function Solo(firstName, lastName, genre) { //Funkcija koja sluzi za kreiranje objekta preko objektnog konstruktora
    Band.call(this, `${firstName} ${lastName}`, genre); //Nasljeđuje metode i svojstva od Band funkcije
    this.type = "Solo";
}

function Bands() { //Objekt koji koristimo kao state managment 
    let list = [];
    let usedIds = [];
    this.lastId = null;
